set CFLAGS=-std=c++0x -O3 -g -m32 -DDLL_EXPORT -DCURL_STATICLIB -Wall -Wextra -I C:\Users\artik\mingw\packages\include
set LINK=-L C:\Users\artik\mingw\packages\lib -lcurl -lwinmm -lwldap32 -lws2_32 -ltiff -lz
